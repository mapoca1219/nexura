	...
	<section class="container">
		<form action="?controller=employe&method=new" method="post">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<div class="form-check">
						<input class="form-check-input" type="radio" name="sexo" value="Masculino" id="sexo" value="<?php echo $data[0]->sexo?>">
						<label class="form-check-label" for="sexo">
							Masculino
						</label>
					</div>
					<div class="form-check">
						<input class="form-check-input" type="radio" name="sexo" value="Femenino" id="sexo" value="<?php echo $data[0]->sexo?>">
						<label class="form-check-label" for="sexo">
							Femenino
						</label>
					</div>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<select class="form-select" aria-label="Default select example" name="area_id" id="area_id" value="<?php echo $data[0]->area_id?>">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<div class="form-check">
						<input class="form-check-input" type="checkbox" value="1" id="boletin" name="boletin" value="<?php echo $data[0]->boletin?>">
